!function (e) {
    ...
    e(document).ready(function () {
      ...
      e(".popup-youtube, .popup-vimeo").magnificPopup({
        ...
        if (e(this).closest(i).find(".item").removeClass("disable"), "all" !== a) for (var s = e(this).closest(i).find(".item"), t = 0; t < s.length; t++) s.eq(t).hasClass(a) || s.eq(t).addClass("disable");
        return !1;
